package com.codegeasse1.hikariadblock.data.datastore
...
import com.codegeasse1.hikariadblock.data.entities.WireGuardProfile
import com.codegeasse1.hikariadblock.data.entities.WireGuardProfileList
import kotlinx.coroutines.flow.Flow
import kotlinx.coroutines.flow.first
import kotlinx.coroutines.flow.map

private val Context.dataStore: DataStore<Preferences> by preferencesDataStore(name = "hikari_prefs")
...
class AppPreferences(private val context: Context) {
    ...
    // SSIDs where Hikari AdBlock auto-pauses; resumes when leaving.
