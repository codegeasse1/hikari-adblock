...
import com.codegeasse1.hikariadblock.worker.RootProxyResumeWorker
...
class RootProxyService : Service() {
    ...
    companion object {
        ...
        private const val CHANNEL_ID = "hikari_root_proxy_channel"

        const val ACTION_START = "com.codegeasse1.hikariadblock.ROOT_START"
        const val ACTION_STOP = "com.codegeasse1.hikariadblock.ROOT_STOP"
        const val ACTION_RESTART = "com.codegeasse1.hikariadblock.ROOT_RESTART"
        const val ACTION_PAUSE_1H = "com.codegeasse1.hikariadblock.ROOT_PAUSE_1H"
